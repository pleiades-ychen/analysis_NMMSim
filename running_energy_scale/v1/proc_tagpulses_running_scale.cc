/*
 * g++ -O2 `$ROOTSYS/bin/root-config --libs` -I$ROOTSYS/include proc_tagpulses_running_scale.cc -o proc_tagpulses_En40_S16
 */
...
int main(int argc, char* argv[])
{
  ...
  strcat(outfilename,Form("_En%f_S%f.root",EnScale,S1));
